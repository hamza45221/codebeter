                                            ...
                                            <li
                                                ...
                                                <div class="d-flex align-items-center w-100">
                                                    ...
                                                    <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                                        <span class="email-list-item-username me-2 h6">{{ $mail->name }}</span>
{{--                                                        <small class="email-list-item-subject d-xl-inline-block d-block">--}}
{{--                                                            <b>Service:</b>{{ $mail->services }}</small--}}
{{--                                                        >--}}
                                                    </div>
                                ...
                                <span
                                    ...
                                    data-label="company"></span>
                                                        <small class="email-list-item-time text-muted">{{ $mail->created_at }}</small>
                          ...
                          ><i
                                  class="ti ti-chevron-left ti-md cursor-pointer"
                                  data-bs-toggle="sidebar"
                                  data-target="#app-email-view"></i
                              ></span>
                                                            <h6 class="text-truncate mb-0 me-2 fw-normal">Contact Mail</h6>
                          ...
                          <span class="btn btn-icon p-0 me-2 text-muted">
                            ...
                            <i class="ti ti-chevron-right ti-md"></i>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center">
                                         <span class="btn btn-icon btn-text-secondary rounded-pill me-1"
                                         ><i class="ti ti-trash ti-md cursor-pointer"></i
                                             ></span>
                                                            {{--                                        <span class="btn btn-icon btn-text-secondary rounded-pill me-1"--}}
                                                            {{--                                        ><i--}}
                                                            {{--                                                class="ti ti-mail ti-md cursor-pointer"--}}
                                                            {{--                                                data-bs-toggle="sidebar"--}}
                                                            {{--                                                data-target="#app-email-view"></i--}}
                                                            {{--                                            ></span>--}}
                                                            {{--                                        <div class="dropdown">--}}
                                                ...
                                                <div class="app-email-view-content py-4">
                                                    ...
                                                    <div class="card email-card-prev mx-sm-6 mx-3">
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                                ...
                                                                <div class="flex-grow-1 ms-1">
                                                                    <h6 class="m-0 fw-normal">{{ $mail->name }}</h6>
                                                                    <small class="text-body">{{ $mail->email }}</small>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center">
                                                                <p class="mb-0 me-4 text-muted">{{ $mail->created_at }}</p>

                                                                {{--                                            <span class="btn btn-icon btn-text-secondary rounded-pill"--}}
                                                                {{--                                            ><i class="ti ti-paperclip ti-md cursor-pointer"></i--}}
                                                                {{--                                                ></span>--}}
                                                                {{--                                            <span class="btn btn-icon btn-text-secondary rounded-pill"--}}
                                                                {{--                                            ><i class="email-list-item-bookmark ti ti-star ti-md cursor-pointer"></i--}}
                                                                {{--                                                ></span>--}}
                                                                {{--                                            <div class="dropdown">--}}
                                                                {{--                                                <button--}}
                                                                {{--                                                    class="btn btn-icon btn-text-secondary rounded-pill p-0"--}}
                                                        ...
                                                        <div class="card-body pt-5">
                                                            <p class="text-muted mb-2"><b>Client Want</b></p>
                                                            {!! $mail->client_want !!}
                                                            <hr />
                                                            <p class="text-muted mb-2"><b>Project Details</b></p>
                                                            {!! $mail->project_detail !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card email-card-last mx-sm-6 mx-3 mt-4">
                                                        ...
                                                        <div class="card-body pt-5">
                                                            <p class="fw-medium">Client Want!</p>
                                                          {!! $mail->client_want !!}

                                                            <hr />
                                                            <p class="text-muted mb-2">Project Details</p>
                                                            {!! $mail->project_detail !!}
                                                        </div>
                                                    </div>
