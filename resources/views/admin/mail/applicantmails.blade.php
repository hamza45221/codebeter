                                ...
                                data-label="company"></span>
                                 ...
                                 <span class="ms-sm-2 me-4">
                                    ...
                                    ></i>
                                                            ...
                                                            <h6 class="text-truncate mb-0 me-2 fw-normal">Applicant Mail</h6>
                                                    ...
                                                    <div class="card email-card-last mx-sm-6 mx-3 mt-4">
                                                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <p class="mb-0 me-4 text-muted">Country: {{ $mail->country }}</p>
                                                            </div>
                                                        </div>

                                                        <div class="card-body pt-5">
                                                            <p >Job Title :<span class="fw-medium"> {{ $mail->job_title }}</span></p>
