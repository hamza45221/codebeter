                ...
                <div class="row g-0">
                    ...
                    <div class="col app-emails-list">
                        <div class="card shadow-none border-0 rounded-0">
                            <div class="card-body emails-list-header p-3 py-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center px-3 mt-2">
                                    <div class="d-flex align-items-center w-100">
                                        <i
                                            class="ti ti-menu-2 ti-lg cursor-pointer d-block d-lg-none me-4 mb-4"
                            ...
                            <i class="email-list-item-bookmark ti ti-star ti-md cursor-pointer ms-1"></i>
                        </span>
                                                    <img
                                                        src="{{ asset('admin/assets/img/avatars/9.png') }}"
                                                        alt="user-avatar"
                                                        class="d-block flex-shrink-0 rounded-circle me-sm-2 me-0"
                                                        height="32"
                                                        width="32" />
                                                    <div class="email-list-item-content ms-2 ms-sm-0 me-2">
                                                        <span class="email-list-item-username me-2 h6">{{ $mail->fullname }}</span>
                                                        <small class="email-list-item-subject d-xl-inline-block d-block">
                                                            <b>Service:</b> {{ $mail->services }}
                                                        </small>
                                                    </div>
                            ...
                            <span
                                ...
                                data-label="company"></span>
                                                        <small class="email-list-item-time text-muted">{{ $mail->created_at->format('d M Y, h:i A') }}</small>
                                                        <ul class="list-inline email-list-item-actions mb-0">
                                            ...
                                            <!-- Email View Section -->
                                            <div class="col app-email-view flex-grow-0 bg-lighter" id="emailView{{ $mail->id }}">
                                 ...
                                 <span class="ms-sm-2 me-4">
                                    <i class="ti ti-chevron-left ti-md cursor-pointer back-btn"
                                       data-bs-toggle="sidebar"
                                       data-bs-target="#emailView{{ $mail->id }}"
                                    ></i>
                                </span>
                                                            <h6 class="text-truncate mb-0 me-2 fw-normal">Focused Mail</h6>
                                                        ...
                                                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
                                                            <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                                ...
                                                                <div class="flex-grow-1 ms-1">
                                                                    <h6 class="m-0 fw-normal">{{ $mail->fullname }}</h6>
                                                                    <small class="text-body">{{ $mail->email }}</small>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center">
                                                                <p class="mb-0 me-4 text-muted">{{ $mail->created_at->format('d M Y, h:i A') }}</p>
                                                                <p class="mb-0 me-4 text-muted">Budget: {{ $mail->estimated_budget }}</p>
                                                            </div>
                                                        </div>

                                                        <div class="card-body pt-5">
                                                            <p class="fw-medium">Project Details</p>
                                                            <p>{!! $mail->project_desc !!}</p>
                                                            <hr />
                                                            <p class="text-muted mb-2">Attachment</p>

                                                            @if(!empty($mail->upload_pro_detail))
                                                                <div class="cursor-pointer">
                                                                    <i class="ti ti-file"></i>
                                                                    <a href="{{ asset( $mail->upload_pro_detail) }}" target="_blank">
                                                                        <span class="align-middle ms-1">{{ basename($mail->upload_pro_detail) }}</span>
                                                                    </a>
                                                                </div>
                                                            @else
                                ...
                                @else
                                    <ul class="list-unstyled m-0">
                                        <li class="email-list-empty text-center py-4 text-muted">No project mails found.</li>
                                    </ul>
                                @endif
                            </div>
                        </div>
