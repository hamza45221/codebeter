                    ...
                    <div class="card card-body bg-body bg-opacity-25 bg-blur border border-white border-opacity-10 position-relative rounded-4 shadow-primary text-center p-4 p-sm-5">
                        ...
                        <form class="mt-2 mt-sm-4" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3 position-relative">
                                <!-- Password -->
                                <div class="mb-3 position-relative">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" id="psw-input" placeholder="Enter your password">
                            ...
                            <div class="mb-3 d-sm-flex justify-content-between">
                                <div>
                                    <input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} class="form-check-input border" id="rememberCheck">
                            ...
                            <div class="d-flex justify-content-center gap-3">
                                ...
                                <a class="btn btn-icon border bg-white" href="{{ route('auth.redirect') }}"><i class="bi bi-google lh-base text-google-icon"></i></a>
                            </div>

                            <!-- Copyright -->
                            <div class="text-body small mt-3"> Copyrights ©2025 CodeBeter. Build by <a href="{{ route('index') }}" target="_blank" class="text-body text-primary-hover hover-underline-animation">CodeBeter</a>. </div>
                        </form>
                        <!-- Form END -->
                    </div>
                    <!-- Sign in END -->
